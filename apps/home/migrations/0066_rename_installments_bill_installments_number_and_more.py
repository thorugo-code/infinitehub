# Generated by Django 4.2.11 on 2024-04-01 18:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0065_profile_authentication'),
    ]
    ...
    operations = [
        ...
        migrations.RemoveField(
            model_name='bill',
            name='installments_value_currency',
        ),
        migrations.RemoveField(
            model_name='bill',
            name='project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='BRL', max_digits=14)),
                ('bill', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='installments', to='home.bill')),
            ],
        ),
    ]
